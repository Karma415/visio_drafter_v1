...
export function InspectorPanel() {
  ...
  const selectedShape = activeTool === 'select' || activeTool === 'move' ? getActivePage(drawing)?.shapes?.find((shape) => shape.id === selectedId) : undefined;
