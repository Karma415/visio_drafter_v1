...
export const WALL_DEFINITIONS: Record<WallType, { label: string; color: string; defaultThicknessMm: number; pattern: WallPattern }> = {
  exterior_masonry: { label: 'Exterior masonry wall', color: '#334155', defaultThicknessMm: 304.8, pattern: 'masonry-joints' },
  exterior_concrete: { label: 'Exterior concrete wall', color: '#334155', defaultThicknessMm: 203.2, pattern: 'concrete-stipple' },
  party_wall: { label: 'Party wall', color: '#334155', defaultThicknessMm: 304.8, pattern: 'double-line' },
  unit_demising: { label: 'Unit demising wall', color: '#334155', defaultThicknessMm: 152.4, pattern: 'double-line' },
  corridor: { label: 'Corridor wall', color: '#334155', defaultThicknessMm: 152.4, pattern: 'dash-line' },
